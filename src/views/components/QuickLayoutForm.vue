<template>
  <div class="quick-layout-form">
    <div class="form-row">
      <div class="form-group">
        ...
        <div class="input-wrapper">
          <el-input-number v-model="config.rows" :min="1" :max="5" size="small"></el-input-number>
        </div>
      </div>
      <div class="form-group">
        <div class="label-wrapper">
        ...
        <div class="input-wrapper">
          <el-input v-model="config.height" size="small" style="width: 100%;" placeholder="默认自适应, 可输入自定义高度">
      ...
      <div class="form-group">
        ...
        <div class="input-wrapper">
          <el-select v-model="config.columnPreset" size="small" style="width: 100%;" @change="handlePresetChange">
    ...
    <div class="form-group" v-if="config.columnPreset === 'custom'" style="margin-top: 10px;">
      <div class="label-wrapper">
        <label>自定义:</label>
      </div>
      <div class="input-wrapper">
        <el-input v-model="config.customRatio" size="small" placeholder="例如: 1:2:1" @change="handleCustomRatioChange"></el-input>

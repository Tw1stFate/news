    ...
    <div class="search-container">
      <div class="search-header">
        <div class="search-input-wrapper">
          ...
          <el-button v-if="hasSearched" plain @click="resetSearch">重置</el-button>
        </div>
      </div>
      
      <div class="search-content">
        <div class="search-history" v-if="!results.length && searchHistory.length && !loading">
        ...
        <div class="hot-searches" v-if="!results.length && !hasSearched && !loading">
        ...
        <div class="search-results-wrapper" v-if="hasSearched && !loading">
          <div class="results-header">
            <h3>搜索结果 <span v-if="results.length">({{ results.length }})</span></h3>
            ...
            <div 
              ...
              <div class="result-content">
                ...
                <div class="result-meta">
                  <span class="result-date"><i class="el-icon-date"></i> {{ item.date }}</span>
                  <span class="result-category" v-if="item.category">
                    <el-tag size="mini" :type="getCategoryType(item.category)">{{ item.category }}</el-tag>
                  </span>
...
export default {
  ...
  computed: {
    filteredResults() {
      if (this.currentFilter === 'all') {
        ...
        return this.results.filter(item => item.category === this.currentFilter);
      }
    }
  },
  watch: {
  ...
  methods: {
    ...
    addToHistory(keyword) {
      ...
      let history = this.searchHistory.filter(item => item !== trimmedKeyword);
